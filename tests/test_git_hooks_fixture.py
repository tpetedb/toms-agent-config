...
def test_a_staged_hand_edit_of_the_owners_page_is_refused(repo: Repo) -> None:
    ...
    # Q14 stays open until the owner creates the machine account.
    edited = page.replace("- [ ] Q14 ", "- [x] Q14 ")
    assert edited != page, "the page has no open Q14 to tick"
    repo.write("TODO.HUMAN.md", edited)
